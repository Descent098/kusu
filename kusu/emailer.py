...
Usage:
    The easiest way to use this file is to just import the send_mail function as a module.
...
TODO:
    ...
    * Move import smtp_from_json to a more general function in serialization
...
def send_email(smtp_config_path="",
    ...
    message="Hello World! \nI am a test email!",
    attachment=os.path.join("configuration", "test", "Work-desktop-wallpaper.png"),
    test=False):
